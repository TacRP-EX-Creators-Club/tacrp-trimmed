...
// names and stuff
SWEP.PrintName = "P226" // Apparently this is specifically the XM25 model adopted by the Navy SEALs but i dont wanna specify it
...
SWEP.Trivia_Caliber = "9x19mm" // ... because the XM25 is 9mm only and doesn't come in 13 rounders
